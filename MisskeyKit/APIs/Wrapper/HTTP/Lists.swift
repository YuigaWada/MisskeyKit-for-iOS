...
extension MisskeyKit {
    public class Lists: Api {
        ...
        public func pullUser(listId: String = "", userId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            handler.handleAPI(needApiKey: true, api: "users/lists/pull", params: params, type: Bool.self) { _, error in
        ...
        public func pushUser(listId: String = "", userId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/push", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
        ...
        public func create(name: String = "", result callback: @escaping ListCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/create", params: params, type: ListModel.self) { list, error in
        ...
        public func delete(listId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/delete", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
        ...
        public func show(listId: String = "", result callback: @escaping ListCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/show", params: params, type: ListModel.self) { list, error in
                if let error = error { callback(nil, error); return }
                guard let list = list else { callback(nil, error); return }
        ...
        public func getMyLists(listId: String = "", result callback: @escaping ListsCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/list", params: params, type: [ListModel].self) { list, error in
                if let error = error { callback(nil, error); return }
                guard let list = list else { callback(nil, error); return }
        ...
        public func changeListName(listId: String = "", name: String = "", result callback: @escaping BooleanCallBack) {
            update(listId: listId, name: name, result: callback)
        }
        ...
        public func update(listId: String = "", name: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/lists/update", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
    }
