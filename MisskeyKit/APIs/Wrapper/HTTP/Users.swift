...
extension MisskeyKit {
    public class Users: Api {
        ...
        public func showUser(userId: String = "", host: String = "", completion callback: @escaping OneUserCallBack) {
            ...
            handler.handleAPI(needApiKey: true, api: "users/show", params: params, type: UserModel.self) { user, error in
        ...
        public func showUser(userIds: [String] = [], host: String = "", completion callback: @escaping UsersCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/show", params: params, type: [UserModel].self) { users, error in
                if let error = error { callback(nil, error); return }
        ...
        public func i(completion callback: @escaping OneUserCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i", params: params, type: UserModel.self) { users, error in
                if let error = error { callback(nil, error); return }
                guard let users = users else { callback(nil, error); return }
        ...
        public func getAllFavorites(limit: Int = 10, sinceId: String = "", untilId: String = "", completion callback: @escaping NotesCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i/favorites", params: params, type: [NoteModel].self) { notes, error in
                if let error = error { callback(nil, error); return }
        ...
        public func getLikedPages(limit: Int = 10, sinceId: String = "", untilId: String = "", completion callback: @escaping PagesCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i/page-likes", params: params, type: [PageModel].self) { notes, error in
                if let error = error { callback(nil, error); return }
                guard let notes = notes else { callback(nil, error); return }
        ...
        public func getMyPages(limit: Int = 10, sinceId: String = "", untilId: String = "", completion callback: @escaping PagesCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i/pages", params: params, type: [PageModel].self) { notes, error in
                if let error = error { callback(nil, error); return }
                guard let notes = notes else { callback(nil, error); return }
        ...
        public func updateMyAccount(name: String = "", description: String = "", lang: String = "", location: String = "", birthday: String = "", avatarId: String = "", bannerId: String = "", fields: [Any] = [], isLocked: Bool? = nil, carefulBot: Bool? = nil, autoAcceptFollowed: Bool? = nil, isBot: Bool? = nil, isCat: Bool? = nil, autoWatch: Bool? = nil, alwaysMarkNsfw: Bool? = nil, pinnedPageId: String? = "", result callback: @escaping OneUserCallBack) {
            ...
            handler.handleAPI(needApiKey: true, api: "i/update", params: params as [String: Any], type: UserModel.self) { myInfo, error in
                if let error = error { callback(nil, error); return }
        ...
        public func pin(noteId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i/pin", params: params, type: Bool.self) { _, error in
        ...
        public func unpin(noteId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "i/unpin", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
        ...
        public func follow(userId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/create", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
        ...
        public func unfollow(userId: String = "", result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/delete", params: params, type: Bool.self) { _, error in
                callback(error == nil, error)
            }
        }
        ...
        public func getFollowers(userId: String = "", username: String = "", host: String = "", limit: Int = 10, sinceId: String = "", untilId: String = "", completion callback: @escaping UsersCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/followers", params: params, type: [UserModel].self) { posts, error in
                if let error = error { callback(nil, error); return }
        ...
        public func getFollowing(userId: String = "", username: String = "", host: String = "", limit: Int = 10, sinceId: String = "", untilId: String = "", completion callback: @escaping UsersCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/following", params: params, type: [UserModel].self) { posts, error in
                if let error = error { callback(nil, error); return }
                guard let posts = posts else { callback(nil, error); return }
        ...
        public func getFrequentlyRepliedUsers(userId: String = "", limit: Int = 10, completion callback: @escaping UsersCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/get-frequently-replied-users", params: params, type: [UserModel].self) { posts, error in
                if let error = error { callback(nil, error); return }
                guard let posts = posts else { callback(nil, error); return }
        ...
        public func getUserRelationship(userId: String, result callback: @escaping OneUserRelationshipCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/relation", params: params, type: UserRelationship.self) { users, error in
        ...
        public func block(userId: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "blocking/create", params: params, type: Bool.self) { _, error in
        ...
        public func unblock(userId: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "blocking/delete", params: params, type: Bool.self) { _, error in
                callback(error == nil, nil)
            }
        }
        ...
        public func getBlockingList(limit: Int = 30, sinceId: String = "", untilId: String = "", result callback: @escaping BlockListCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "blocking/list", params: params, type: [BlockList].self) { users, error in
        ...
        public func reportAsAbuse(userId: String, comment: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/report-abuse", params: params, type: Bool.self) { _, error in
                callback(error == nil, nil)
            }
        }
        ...
        public func getUserRecommendation(limit: Int = 10, offset: Int = 0, result callback: @escaping UsersCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "users/recommendation", params: params, type: [UserModel].self) { users, error in
        ...
        public func acceptFollowRequest(userId: String, comment: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/requests/accept", params: params, type: Bool.self) { _, error in
                callback(error == nil, nil)
            }
        }
        ...
        public func cancelFollowRequest(userId: String, comment: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/requests/cancel", params: params, type: Bool.self) { _, error in
                callback(error == nil, nil)
            }
        }
        ...
        public func rejectFollowRequest(userId: String, comment: String, result callback: @escaping BooleanCallBack) {
            ...
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/requests/reject", params: params, type: Bool.self) { _, error in
                callback(error == nil, nil)
            }
        }
        
        public func getFollowRequests(result callback: @escaping ([FollowRequestModel]?, MisskeyKitError?) -> Void) {
            var params = [:] as [String: Any]
            
            params = params.removeRedundant()
            handler.handleAPI(needApiKey: true, api: "following/requests/list", params: params, type: [FollowRequestModel].self) { users, error in
